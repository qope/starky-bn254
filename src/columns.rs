...
pub const IS_ADDFP254: usize = IS_MULMOD + 1;
pub const IS_MULFP254: usize = IS_ADDFP254 + 1;
pub const IS_SUBFP254: usize = IS_MULFP254 + 1;
pub const IS_SUBMOD: usize = IS_SUBFP254 + 1;
pub const IS_LT: usize = IS_SUBMOD + 1;
pub const IS_GT: usize = IS_LT + 1;
pub const IS_BYTE: usize = IS_GT + 1;

pub const START_SHARED_COLS: usize = IS_BYTE + 1;
...
/// the second row.)
pub const NUM_SHARED_COLS: usize = 6 * N_LIMBS;
pub const SHARED_COLS: Range<usize> = START_SHARED_COLS..START_SHARED_COLS + NUM_SHARED_COLS;

pub const INPUT_REGISTER_0: Range<usize> = START_SHARED_COLS..START_SHARED_COLS + N_LIMBS; // 14~29
pub const INPUT_REGISTER_1: Range<usize> = INPUT_REGISTER_0.end..INPUT_REGISTER_0.end + N_LIMBS; // 30~45
pub const INPUT_REGISTER_2: Range<usize> = INPUT_REGISTER_1.end..INPUT_REGISTER_1.end + N_LIMBS; // 45~61
pub const OUTPUT_REGISTER: Range<usize> = INPUT_REGISTER_2.end..INPUT_REGISTER_2.end + N_LIMBS; // 62~77

// NB: Only one of AUX_INPUT_REGISTER_[01] or AUX_INPUT_REGISTER_DBL
// will be used for a given operation since they overlap
pub const AUX_INPUT_REGISTER_0: Range<usize> = OUTPUT_REGISTER.end..OUTPUT_REGISTER.end + N_LIMBS; // 78~93
pub const AUX_INPUT_REGISTER_1: Range<usize> =
    AUX_INPUT_REGISTER_0.end..AUX_INPUT_REGISTER_0.end + N_LIMBS;
pub const AUX_INPUT_REGISTER_DBL: Range<usize> =
...
// operations.
pub const AUX_REGISTER_0: Range<usize> = START_SHARED_COLS..START_SHARED_COLS + N_LIMBS;
pub const AUX_REGISTER_1: Range<usize> = AUX_REGISTER_0.end..AUX_REGISTER_0.end + 2 * N_LIMBS;
pub const AUX_REGISTER_2: Range<usize> = AUX_REGISTER_1.end..AUX_REGISTER_1.end + 2 * N_LIMBS - 1;
...
pub const MUL_AUX_INPUT_LO: Range<usize> = AUX_INPUT_REGISTER_0;
pub const MUL_AUX_INPUT_HI: Range<usize> = AUX_INPUT_REGISTER_1;
...
// over two rows).
pub const MODULAR_INPUT_0: Range<usize> = INPUT_REGISTER_0;
pub const MODULAR_INPUT_1: Range<usize> = INPUT_REGISTER_1;
pub const MODULAR_MODULUS: Range<usize> = INPUT_REGISTER_2;
pub const MODULAR_OUTPUT: Range<usize> = OUTPUT_REGISTER;
pub const MODULAR_QUO_INPUT: Range<usize> = AUX_INPUT_REGISTER_DBL;
pub const MODULAR_OUT_AUX_RED: Range<usize> = Range {
    start: 110,
    end: 126,
};
pub const MODULAR_AUX_INPUT_LO: Range<usize> = Range {
    start: 126,
    end: 157,
};
pub const MODULAR_AUX_INPUT_HI: Range<usize> = Range {
    start: 172,
    end: 203,
};
